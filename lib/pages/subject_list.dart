        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: ListView(
                children: const [
                  SubjectListTile(subjectCode: 'CRP 1102'),
                  SubjectListTile(subjectCode: 'CMD 2913'),
                  SubjectListTile(subjectCode: 'CIT 2134'),
                ],
              ),
            ),
          ],
    ...
    return Container(
      ...
      child: ListTile(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => EditSubj()),
          );
        },
      ),
    );
